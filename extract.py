...
if __name__ == "__main__":
    ...
    for byte_index in range(PLAINTEXT_BYTE_NUM):
        ...
        plaintext_samples_averages = compute_plaintext_averages_for_byte(
            aes_data, byte_index
        )
        # Calculate corrected averages for the current byte
        corrected_plaintext_samples_averages = calculate_corrected_averages(
            plaintext_samples_averages, all_samples_averages
        )
